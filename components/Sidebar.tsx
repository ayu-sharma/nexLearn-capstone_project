    ...
    <div className='h-full px-6 py-8 dark:text-[#121417] text-[#F2F2F2] bg-[#121417] dark:bg-[#F2F2F2] w-[15%] shadow-md rounded-tr-lg rounded-br-lg'>
        <div className='flex flex-col justify-between h-full font-medium text-sm'>
            <div className='flex flex-col'>
                <Image src={isDarkMode ? logoL : logoD} alt='NexLearn Logo' height={24} className='pb-4 px-2'/>
            ...
            <div className='flex flex-col gap-y-2 '>
                <div className='flex items-center gap-x-2 p-2 rounded-md hover:bg-white/10 dark:hover:bg-black/10 cursor-pointer transition'>
                    <svg className="w-5 h-5 text-[#F2F2F2] dark:text-[#121417]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
