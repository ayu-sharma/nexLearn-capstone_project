  ...
  return (
    <div className="relative h-screen w-full">
      <div className="flex xl:block flex-row-reverse xl:pt-0 xl:px-0 pt-5 px-6 w-full justify-between">
        <RightNav toggleSidebar={toggleSidebar} />
        <Sidebar
      ...
      <div className="px-6 xl:pl-[13rem] py-8 flex flex-col w-full">
        <div className="text-2xl font-semibold hidden xl:block mb-8">
          {selectedGroup}
        </div>
        {renderComponent()}
      </div>
...
const RightNav = ({ toggleSidebar }: { toggleSidebar: () => void }) => {
  return (
