...
import BackToTop from "@/components/Floater";

// Create a separate authentication component
const AuthCheck = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (hasToken) {
      // If token exists, navigate directly
    ...
    // No return dependency array means this runs only once after initial render
  }, []);
...
const Landing = () => {
  // Wrap the entire component in the auth check
  return (
    <AuthCheck>
